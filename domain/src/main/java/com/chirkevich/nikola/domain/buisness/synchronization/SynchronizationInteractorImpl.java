...
public class SynchronizationInteractorImpl implements SynchronizationInteractor {
    ...
    public SynchronizationInteractorImpl(AnswerRemoteRepository answerRemoteRepository,
